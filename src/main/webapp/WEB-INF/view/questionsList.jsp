                        ...
                        <a class="nav-link" role="tab" data-toggle="tab">
                            ...
                            <div class="row">
                                <div class="column">
                                    ...
                                    <div>
                                        <a href="/submitAnswer?id=${question.id.toString()}" class="btn btn-outline-secondary">Answer</a>
                                ...
                                <div class="column">
                                    ...
                                    <div>
                                        <a href="/submitComment?id=${question.id.toString()}" class="btn btn-outline-secondary">Comment</a>
                                    </div>
                                </div>
                                <div class="column">
                                    <!--<form class="form" method="get" action="comment">
                                    ...
                                    <div>
                                        <a href="/question?id=${question.id.toString()}" class="btn btn-outline-secondary">Go to question</a>
                                    </div>
                                </div>
                            </div>
                        </a>
